...
class EncModule(nn.Module):
    def __init__(self, in_channels, nclass, ncodes=32, se_loss=True, norm_layer=None):
        ...
        self.attention = nn.Sequential(
            ...
            attention.nn.Encoding(D=in_channels, K=ncodes),
            attention.nn.BatchNorm1d(ncodes),
            nn.ReLU(inplace=True),
            attention.nn.Mean(dim=1))
...
def get_encnet_resnet50_pcontext(pretrained=False, root='~/.attention/models', **kwargs):
...
def get_encnet_resnet101_pcontext(pretrained=False, root='~/.attention/models', **kwargs):
    r"""EncNet-PSP model from the paper `"Context Encoding for Semantic Segmentation"
    <https://arxiv.org/pdf/1803.08904.pdf>`_
    Parameters
    ----------
...
def get_encnet_resnet50_ade(pretrained=False, root='~/.attention/models', **kwargs):
    r"""EncNet-PSP model from the paper `"Context Encoding for Semantic Segmentation"
    <https://arxiv.org/pdf/1803.08904.pdf>`_
    Parameters
    ----------
...
def get_encnet_resnet101_ade(pretrained=False, root='~/.attention/models', **kwargs):
    r"""EncNet-PSP model from the paper `"Context Encoding for Semantic Segmentation"
    <https://arxiv.org/pdf/1803.08904.pdf>`_
    Parameters
    ----------
...
def get_encnet_resnet152_ade(pretrained=False, root='~/.attention/models', **kwargs):
    r"""EncNet-PSP model from the paper `"Context Encoding for Semantic Segmentation"
    <https://arxiv.org/pdf/1803.08904.pdf>`_
    Parameters
    ----------
